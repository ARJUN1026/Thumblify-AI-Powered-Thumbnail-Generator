...
const Generate = ({ setToast }) => {
  ...
  const handleRecreate = async (event) => {
    ...
    try {
      ...
      setToast({
        type: "success",
        message: "Thumbnail recreated successfully",
      });
    } catch (error) {
      setToast({ type: "error", message: error.message });
    } finally {
    ...
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.1fr,0.9fr]">
          ...
          {activeTab === "generate" ? (
            <form onSubmit={handleGenerate} className="space-y-5">
              <InputBlock
                ...
                onChange={(value) =>
                  setGenerateForm({ ...generateForm, title: value })
                }
              ...
              <SelectBlock
                ...
                onChange={(value) =>
                  setGenerateForm({ ...generateForm, aspectRatio: value })
                }
              />
              <SelectBlock
                label="Style"
                ...
                options={styles}
                onChange={(value) =>
                  setGenerateForm({ ...generateForm, style: value })
                }
              />
              <PaletteBlock
                label="Color Palette"
              ...
              <InputBlock
                ...
                onChange={(value) =>
                  setGenerateForm({ ...generateForm, prompt: value })
                }
              ...
              <InputBlock
                ...
                onChange={(value) =>
                  setGenerateForm({ ...generateForm, sourceImage: value })
                }
            ...
            <form onSubmit={handleRecreate} className="space-y-5">
              <InputBlock
                ...
                onChange={(value) =>
                  setRecreateForm({ ...recreateForm, title: value })
                }
              ...
              <InputBlock
                ...
                onChange={(value) =>
                  setRecreateForm({ ...recreateForm, sourceImage: value })
                }
              ...
              <InputBlock
                ...
                onChange={(value) =>
                  setRecreateForm({ ...recreateForm, changeRequest: value })
                }
              ...
              <SelectBlock
                ...
                options={aspectRatios}
                onChange={(value) =>
                  setRecreateForm({ ...recreateForm, aspectRatio: value })
                }
              />
              <SelectBlock
                label="Style"
                ...
                options={styles}
                onChange={(value) =>
                  setRecreateForm({ ...recreateForm, style: value })
                }
              />
              <PaletteBlock
                label="Color Palette"
        ...
        <div className="glass-card rounded-[32px] p-6">
          ...
          <div 
            className={`mt-5 overflow-hidden rounded-[28px] border border-white/10 bg-slate-900/80 transition-all duration-500 ease-in-out ${
              (activeTab === 'generate' ? generateForm.aspectRatio : recreateForm.aspectRatio) === '9:16' ? 'aspect-[9/16] max-h-[600px]' : 
              (activeTab === 'generate' ? generateForm.aspectRatio : recreateForm.aspectRatio) === '1:1' ? 'aspect-square' : 
              (activeTab === 'generate' ? generateForm.aspectRatio : recreateForm.aspectRatio) === '4:5' ? 'aspect-[4/5] max-h-[550px]' : 
              'aspect-video'
          ...
          >
            {preview ? (
              ...
              <div className="flex h-full min-h-[300px] w-full items-center justify-center bg-gradient-to-br from-brand-pink/10 via-slate-900 to-brand-purple/10 px-6 text-center text-slate-400">
          ...
          <div className="mt-5 space-y-3">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
              ...
              <p className="mt-2 text-sm text-slate-200">
                {preview?.prompt || "No prompt yet"}
              </p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-300">
              Tip: use short titles and strong palette contrast for better
              results.
            </div>
          </div>
        </div>
  ...
  return (
    <div>
      ...
      <input
        ...
        required={
          label !== "Optional Prompt" && label !== "Optional Image Upload URL"
        }
      />
    </div>
  );
